...
class BrowserView(QMainWindow):
    ...
    dialog_trigger = QtCore.pyqtSignal(bool)
    ...
    def _handle_open_file_dialog(self, is_folder):
        print "handle"
    ...
    def open_file_dialog(self, is_folder):
        print "open_file_dialog"
        self.dialog_trigger.emit(is_folder)
...
def open_file_dialog(is_folder):
    if BrowserView.instance is not None:
        BrowserView.instance.open_file_dialog(is_folder)
    else:
        raise Exception("Create a web view window first, before invoking this function")